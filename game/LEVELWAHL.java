...
public class LEVELWAHL
{
    ...
    public LEVELWAHL()
    {
        ...
        buttons[0] = new game.BUTTON(135,195, "", texturen, f); 
        buttons[1] = new game.BUTTON(280,210, "", texturen, f); 
        buttons[2] = new game.BUTTON(426,195, "", texturen, f);
        buttons[3] = new game.BUTTON(560,236, "", texturen, f); 
        buttons[4] = new game.BUTTON(544,367, "", texturen, f); 
        buttons[5] = new game.BUTTON(415,458, "", texturen, f); 
        buttons[6] = new game.BUTTON(247,436, "", texturen, f); 
        buttons[7] = new game.BUTTON(158,532, "", texturen, f); 
        buttons[8] = new game.BUTTON(295,666, "", texturen, f); 
        buttons[9] = new game.BUTTON(543,651, "", texturen, f); 
